...
return [
    ...
    'department' => [
        'index' => [
            'title' => 'Quản lý Khoa bệnh',
            'table' => 'Danh sách Khoa bệnh',
        ],
        'create' => [
            'title' => 'Thêm mới Khoa bệnh'
        ],
        'edit' => [
            'title' => 'Cập nhật thông tin Khoa bệnh'
        ],
        'delete' => [
            'title' => 'Xóa thông tin Khoa bệnh'
        ],
    ],
    'room' => [
        'index' => [
            'title' => 'Quản lý Phòng bệnh',
            'table' => 'Danh sách Phòng bệnh',
        ],
        'create' => [
            'title' => 'Thêm mới Phòng bệnh'
        ],
        'edit' => [
            'title' => 'Cập nhật thông tin Phòng bệnh'
        ],
        'delete' => [
            'title' => 'Xóa thông tin Phòng bệnh'
        ],
    ],
    'expenseCatalogue' => [
        'index' => [
    ...
    'bed' => [
        'index' => [
            ...
            'table' => 'Danh sách giường bệnh'
        ],
        'create' => [
            'title' => 'Thêm mới giường bệnh'
        ],
        'edit' => [
            'title' => 'Cập nhật giường bệnh'
        ],
        'delete' => [
    ...
    'visit' => [
        'index' => [
            'title' => 'Quản lý phiếu khám bệnh',
            'table' => 'Danh sách phiếu khám bệnh'
        ],
        'create' => [
            'title' => 'Thêm mới phiếu khám bệnh'
        ],
        'edit' => [
            'title' => 'Cập nhật phiếu khám bệnh'
        ],
        'delete' => [
    ...
    'list_patient' => 'Danh sách bệnh nhân',
    'search' => 'Tìm kiếm',
    'create_patient' => 'Thêm mới bệnh nhân',
    'placeholder' => 'Nhập Từ khóa bạn muốn tìm kiếm...',
    'info_patient' => 'Thông tin bệnh nhân',
    'problem_patient' => 'Vấn đề của bệnh nhân',
