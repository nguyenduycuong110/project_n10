                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">Chứng chỉ hành nghề</label>
                                    <input 
                                        type="text"
                                        name="certificate"
                                        value="{{ old('certificate', ($user->certificate) ?? '' ) }}"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">Nhóm Nhân viên <span class="text-danger">(*)</span></label>
                                    <select name="user_catalogue_id" class="form-control setupSelect2">
                                        ...
                                        <option {{ 
                                            $val->id == old('user_catalogue_id', (isset($user->user_catalogue_id)) ? $user->user_catalogue_id : '') ? 'selected' : '' 
                        ...
                        <div class="row mb15">
                            <div class="col-lg-4">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">Khoa bệnh </label>
                                        ...
                                        @if(isset($departments))
                                            @foreach($departments as $key => $val)
                                                <option 
                                                    value="{{ $val->id }}"
                                                    {{ 
                                                        $val->id == old('department_id', (isset($user->department_id)) ? $user->department_id : '') ? 'selected' : '' 
                                                    }}
                                                >
                                                    {{ $val->name }}
                                                </option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">Chức vụ </label>
                                    <select name="position_id" id="" class="setupSelect2 form-control">
                                        ...
                                        @if(isset($positions))
                                           @foreach($positions as $key => $val)
                                               <option 
                                                    value="{{ $val->id }}"
                                                    {{ 
                                                        $val->id == old('position_id', (isset($user->position_id)) ? $user->position_id : '') ? 'selected' : '' 
                                                    }}
                                                >
                                                    {{ $val->name }}
                                                </option>
