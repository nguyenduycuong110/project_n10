...
use App\Http\Controllers\Backend\Expense\ExpenseCatalogueController;
...
Route::get('reception/login', [ReAuthController::class, 'index'])->name('reception.auth.login'); 

Route::post('reception/check/login', [ReAuthController::class, 'login'])->name('reception.auth.dologin');
...
Route::group(['middleware' => ['reception','set.guard.session:reception']], function () {
    ...
    Route::get('reception/patient/create', [ReReceptionController::class, 'createPatient'])->name('reception.patient.create'); 

    Route::post('reception/patient/store', [ReReceptionController::class, 'storePatient'])->name('reception.patient.store'); 

    Route::get('reception/patient/{id}/visit', [ReReceptionController::class, 'patientVisit'])->where(['id' => '[0-9]+'])->name('reception.patient.visit');

    Route::post('reception/patient/{id}/update', [ReReceptionController::class, 'updateVisit'])->where(['id' => '[0-9]+'])->name('reception.patient.updateVisit');

    Route::get('ajax/reception/getPatient', [AjaxReceptionController::class, 'getPatient'])->name('ajax.reception.getPatient');

    Route::get('ajax/clinic/getClinic', [AjaxReceptionController::class, 'getClinic'])->name('ajax.clinic.getClinic'); 

    Route::post('ajax/visit/createVisit', [AjaxReceptionController::class, 'createVisit'])->name('ajax.visit.createVisit');
...
Route::group(['middleware' => ['admin','locale','backend_default_locale','set.guard.session:web']], function () {
   ...
   /*CRM*/
    ...
    Route::group(['prefix' => 'department'], function () {
        ...
        Route::get('{id}/edit', [DepartmentController::class, 'edit'])->where(['id' => '[0-9]+'])->name('department.edit');
        Route::post('{id}/update', [DepartmentController::class, 'update'])->where(['id' => '[0-9]+'])->name('department.update');
        Route::get('{id}/delete', [DepartmentController::class, 'delete'])->where(['id' => '[0-9]+'])->name('department.delete');
        Route::delete('{id}/destroy', [DepartmentController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('department.destroy');
    });
    ...
    Route::group(['prefix' => 'expense/catalogue'], function () {
        Route::get('index', [ExpenseCatalogueController::class, 'index'])->name('expense.catalogue.index');
        Route::get('create', [ExpenseCatalogueController::class, 'create'])->name('expense.catalogue.create');
        Route::post('store', [ExpenseCatalogueController::class, 'store'])->name('expense.catalogue.store');
        Route::get('{id}/edit', [ExpenseCatalogueController::class, 'edit'])->where(['id' => '[0-9]+'])->name('expense.catalogue.edit');
        Route::post('{id}/update', [ExpenseCatalogueController::class, 'update'])->where(['id' => '[0-9]+'])->name('expense.catalogue.update');
        Route::get('{id}/delete', [ExpenseCatalogueController::class, 'delete'])->where(['id' => '[0-9]+'])->name('expense.catalogue.delete');
        Route::delete('{id}/destroy', [ExpenseCatalogueController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('expense.catalogue.destroy');
    });
    ...
    Route::group(['prefix' => 'expense'], function () {
        ...
        Route::get('{id}/edit', [ExpenseController::class, 'edit'])->where(['id' => '[0-9]+'])->name('expense.edit');
        Route::post('{id}/update', [ExpenseController::class, 'update'])->where(['id' => '[0-9]+'])->name('expense.update');
        Route::get('{id}/delete', [ExpenseController::class, 'delete'])->where(['id' => '[0-9]+'])->name('expense.delete');
        Route::delete('{id}/destroy', [ExpenseController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('expense.destroy');
    });

    Route::group(['prefix' => 'bed'], function () {
        Route::get('index', [BedController::class, 'index'])->name('bed.index');
        Route::get('create', [BedController::class, 'create'])->name('bed.create');
        Route::post('store', [BedController::class, 'store'])->name('bed.store');
        Route::get('{id}/edit', [BedController::class, 'edit'])->where(['id' => '[0-9]+'])->name('bed.edit');
        Route::post('{id}/update', [BedController::class, 'update'])->where(['id' => '[0-9]+'])->name('bed.update');
        Route::get('{id}/delete', [BedController::class, 'delete'])->where(['id' => '[0-9]+'])->name('bed.delete');
        Route::delete('{id}/destroy', [BedController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('bed.destroy');
    });
    ...
    Route::group(['prefix' => 'patient'], function () {
        ...
        Route::get('{id}/edit', [PatientController::class, 'edit'])->where(['id' => '[0-9]+'])->name('patient.edit');
        Route::post('{id}/update', [PatientController::class, 'update'])->where(['id' => '[0-9]+'])->name('patient.update');
        Route::get('{id}/delete', [PatientController::class, 'delete'])->where(['id' => '[0-9]+'])->name('patient.delete');
        Route::delete('{id}/destroy', [PatientController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('patient.destroy');
    });
    ...
    Route::group(['prefix' => 'visit'], function () {
        ...
        Route::get('{id}/edit', [VisitController::class, 'edit'])->where(['id' => '[0-9]+'])->name('visit.edit');
        Route::post('{id}/update', [VisitController::class, 'update'])->where(['id' => '[0-9]+'])->name('visit.update');
        Route::get('{id}/delete', [VisitController::class, 'delete'])->where(['id' => '[0-9]+'])->name('visit.delete');
        Route::delete('{id}/destroy', [VisitController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('visit.destroy');
    });
    ...
    Route::group(['prefix' => 'position'], function () {
        ...
        Route::get('{id}/edit', [PositionController::class, 'edit'])->where(['id' => '[0-9]+'])->name('position.edit');
        Route::post('{id}/update', [PositionController::class, 'update'])->where(['id' => '[0-9]+'])->name('position.update');
        Route::get('{id}/delete', [PositionController::class, 'delete'])->where(['id' => '[0-9]+'])->name('position.delete');
        Route::delete('{id}/destroy', [PositionController::class, 'destroy'])->where(['id' => '[0-9]+'])->name('position.destroy');
    });
    ...
    Route::group(['prefix' => 'clinic'], function () {
        ...
        Route::get('{id}/edit', [ClinicController::class, 'edit'])->where(['id' => '[0-9]+'])->name('clinic.edit');
        Route::post('{id}/update', [ClinicController::class, 'update'])->where(['id' => '[0-9]+'])->name('clinic.update');
